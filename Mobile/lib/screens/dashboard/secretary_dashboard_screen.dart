...
class _SecretaryDashboardScreenState extends State<SecretaryDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    final pages = [
      ...
      const ChatScreen(contactId: 'admin', contactName: 'Administrador'),
    ];
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            DashboardHeader(role: 'Secretario', avatarText: initials),
            Expanded(
...
class _SecretaryBottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      ...
      const _SecretaryNavItem(label: 'Historial', icon: Icons.history_rounded),
      const _SecretaryNavItem(
        label: 'Recibos',
        icon: Icons.receipt_long_rounded,
      ),
      const _SecretaryNavItem(label: 'Chat', icon: Icons.chat_rounded),
    ];
...
class _SecretaryNavItem {
  ...
  const _SecretaryNavItem({required this.label, required this.icon});
}
